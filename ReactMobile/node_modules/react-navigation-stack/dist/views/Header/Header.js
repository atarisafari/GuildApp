...
class Header extends React.PureComponent {
  ...
  _renderTitleComponent = props => {
    ...
    return <HeaderTitleComponent onLayout={onLayout} allowFontScaling={!!allowFontScaling} style={[color ? { color } : null, layoutPreset === 'center' ? { textAlign: 'center' } : { textAlign: 'left' }, titleStyle]}>
        {titleString}
